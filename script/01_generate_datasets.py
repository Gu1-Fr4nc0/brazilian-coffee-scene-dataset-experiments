...
def main():
    ...
    desc_file = open("/content/crop-image-classification/dataset-brazilian_coffee_scenes/desc.txt")
    ...
    for i, im_name in enumerate(desc):
        im_path = "/content/crop-image-classification/dataset-brazilian_coffee_scenes/images/"
    ...
    pd.DataFrame.from_dict(ds_1).to_csv("/content/crop-image-classification/data/dataset_1.csv", sep = ";", index = False)
    pd.DataFrame.from_dict(ds_2).to_csv("/content/crop-image-classification/data/dataset_2.csv", sep = ";", index = False)
    pd.DataFrame.from_dict(ds_3).to_csv("/content/crop-image-classification/data/dataset_3.csv", sep = ";", index = False)
